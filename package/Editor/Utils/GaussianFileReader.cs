...
namespace GaussianSplatting.Editor.Utils
{
    ...
    public struct OldInputSplatData
    {
        public Vector3 pos;
        public Vector3 nor;
        public Vector3 dc0;
    ...
    public class GaussianFileReader
    {
        ...
        struct LinearizeDataJob : IJobParallelFor
        {
            ...
            public void Execute(int index)
            {
                ...
                //albedo & material
                splat.albedo.x = GaussianUtils.Sigmoid(splat.albedo.x);
                splat.albedo.y = GaussianUtils.Sigmoid(splat.albedo.y);
                splat.albedo.z = GaussianUtils.Sigmoid(splat.albedo.z);

                splat.roughness= GaussianUtils.Sigmoid(splat.roughness);
                splat.metallic = GaussianUtils.Sigmoid(splat.metallic);
