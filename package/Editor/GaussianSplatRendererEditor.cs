...
namespace GaussianSplatting.Editor
{
    ...
    public class GaussianSplatRendererEditor : UnityEditor.Editor
    {
        ...
        SerializedProperty m_PropShaderMode;
        ...
        SerializedProperty m_PropEnvIrradianceMap;
        SerializedProperty m_PropEnvPrefilteredMap;
        SerializedProperty m_PropBRDFLUT;
        SerializedProperty m_PropPointLights;
        SerializedProperty m_PropGSEffects;
        ...
        public void OnEnable()
        {
            ...
            m_PropShaderMode = serializedObject.FindProperty("m_ShaderMode");
            ...
            m_PropEnvIrradianceMap = serializedObject.FindProperty("m_EnvIrradianceMap");
            m_PropEnvPrefilteredMap = serializedObject.FindProperty("m_EnvPrefilteredMap");
            m_PropBRDFLUT = serializedObject.FindProperty("m_BRDFLUT");
            m_PropPointLights = serializedObject.FindProperty("m_PointLights");
            m_PropGSEffects = serializedObject.FindProperty("m_GSEffects");
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.PropertyField(m_PropShaderMode);
            ...
            GUILayout.Label("Relighting Options", EditorStyles.boldLabel);
            EditorGUILayout.PropertyField(m_PropGSEffects);
            EditorGUILayout.PropertyField(m_PropEnvIrradianceMap);
            EditorGUILayout.PropertyField(m_PropEnvPrefilteredMap);
            EditorGUILayout.PropertyField(m_PropBRDFLUT);
            EditorGUILayout.PropertyField(m_PropPointLights);
            ...
            if (m_ResourcesExpanded)
            {
                ...
                EditorGUILayout.PropertyField(m_PropShaderDepth);
